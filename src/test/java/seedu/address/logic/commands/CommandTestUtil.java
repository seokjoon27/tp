...
public class CommandTestUtil {
    ...
    public static final String VALID_TYPE_AMY = "s";
    public static final String VALID_TYPE_BOB = "s";
    public static final String VALID_NAME_AMY = "Amy Bee";
    public static final String VALID_NAME_BOB = "Bob Choo";
    public static final String VALID_PHONE_AMY = "81111111";
    public static final String VALID_PHONE_BOB = "91111111";
    ...
    public static final String VALID_NOTE_AMY = "Good at Math";
    public static final String VALID_NOTE_BOB = "Bad at science";
    public static final String VALID_COST_AMY = "72.50";
    public static final String VALID_COST_BOB = "88";
    ...
    public static final String INVALID_PAY_DESC = " " + PREFIX_PAY + "abc"; // non-numeric cost not allowed
    public static final String INVALID_SCHEDULE_DESC = " " + PREFIX_SCHEDULE + "Monday"; // time is required
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withType(VALID_TYPE_AMY)
                .withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withType(VALID_TYPE_BOB)
