...
public class ScheduleTest {
    ...
    public void constructor_invalidFormat_throwsIllegalArgumentException() {
        ...
        // Invalid day
        assertThrows(IllegalArgumentException.class, () -> new Schedule("Funday 14:00"));
        // Invalid date format
        assertThrows(IllegalArgumentException.class, () -> new Schedule("2025-12-10 14:00"));
        // Completely invalid
    ...
    public void equals_sameValue_returnsTrue() {
        ...
        Schedule schedule2 = new Schedule("Monday 14:00");
    ...
    public void equals_differentValue_returnsFalse() {
        Schedule schedule1 = new Schedule("Monday 14:00");
        Schedule schedule2 = new Schedule("Tuesday 16:00");
