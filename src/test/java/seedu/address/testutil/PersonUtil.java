...
public class PersonUtil {
    ...
    public static String getEditPersonDescriptorDetails(EditPersonDescriptor descriptor) {
        ...
        descriptor.getNote().ifPresentOrElse(note -> sb.append(PREFIX_NOTE).append(note.value).append(" "),
                () -> sb.append(PREFIX_NOTE).append("").append(" "));
        descriptor.getSchedule().ifPresentOrElse(schedule -> sb.append(PREFIX_SCHEDULE).append(schedule.value).append(" "),
