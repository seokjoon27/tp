    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Student(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), EMPTY_NOTE, EMPTY_SCHEDULE,null, UNPAID_STATUS,
                getTagSet("colleagues", "friends")),
            new Student(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), EMPTY_NOTE, EMPTY_SCHEDULE,null, UNPAID_STATUS,
            ...
            new Parent(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), EMPTY_NOTE, null, UNPAID_STATUS,
                getTagSet("classmates")),
            new Parent(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Street 85, #11-31"), EMPTY_NOTE, null, UNPAID_STATUS,
