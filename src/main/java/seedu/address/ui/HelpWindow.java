...
public class HelpWindow extends UiPart<Stage> {
    public static final String HELP_MESSAGE = "▶ Add\n"
                ...
                + "reset all\n\n"
                + "▶ Schedule\n"
                + "schedule INDEX schedule/DAY STARTTIME-ENDTIME [adds schedule with specific day and time]\n"
                + "schedule INDEX schedule/DATE STARTTIME-ENDTIME [adds schedule with specific date and time]\n"
                + "schedule INDEX [deletes schedule]\n\n"
                + "▶ Unlink\n"
